...
<section id="mood-section" class="px-4 py-6 hidden">
    <div class="bg-white rounded-lg shadow-sm p-4">
        ...
        <div class="mb-6">
            <label for="mood-detail" class="block text-sm font-medium text-gray-700 mb-2">Ceritakan lebih detail tentang
                perasaanmu:</label>
        ...
        <div class="bg-gray-50 rounded-lg p-4 border border-gray-100">
            ...
            <div class="mb-4">
                ...
                <p class="text-sm text-gray-600">Kecemasan ringan adalah perasaan khawatir atau tegang yang muncul
                    terkait dengan situasi tertentu. Biasanya bersifat sementara dan masih dapat dikelola.</p>
            </div>
            <div class="mb-4">
