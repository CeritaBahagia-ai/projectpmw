    ...
    <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
        ...
        <div class="space-y-4">
            <div class="border border-gray-100 rounded-lg p-4">
                ...
                <p class="text-sm text-gray-700 mb-3">Hari ini saya merasa sangat cemas menghadapi presentasi di kantor.
                    Bagaimana cara kalian mengatasi kecemasan saat harus berbicara di depan banyak orang?</p>
            ...
            <div class="border border-gray-100 rounded-lg p-4">
                ...
                <p class="text-sm text-gray-700 mb-3">Setelah 3 bulan konsisten meditasi setiap pagi, saya merasa jauh
                    lebih tenang menghadapi masalah. Mood saya juga lebih stabil. Sangat merekomendasikan untuk
                    teman-teman yang sering merasa cemas.</p>
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        <button class="flex items-center text-gray-500 cursor-pointer">
                            <i class="ri-heart-line mr-1"></i>
            ...
            <div class="border border-gray-100 rounded-lg p-4">
                ...
                <p class="text-sm text-gray-700 mb-3">Saya kesulitan mengkomunikasikan perasaan saya pada pasangan.
                    Kadang merasa tidak dimengerti. Ada yang punya tips bagaimana cara memulai percakapan tentang
                    perasaan tanpa terkesan menyalahkan?</p>
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        <button class="flex items-center text-gray-500 cursor-pointer">
                            <i class="ri-heart-line mr-1"></i>
