                ...
                <div class="flex-1 overflow-y-auto space-y-4 mb-4" id="chat-container">
                    ...
                    <div class="flex items-start justify-end">
                        <div class="chat-bubble-user bg-primary p-3 max-w-[80%] text-white text-sm">
                            <p>Hai Ceritia, hari ini aku merasa sedikit cemas karena besok ada presentasi penting di kantor.
                            </p>
                        </div>
                    </div>
                    <div class="flex items-start">
                        <div class="chat-bubble-ai bg-gray-100 p-3 max-w-[80%] text-gray-700 text-sm">
                            <p>Aku mengerti perasaan cemas sebelum presentasi penting. Itu hal yang wajar dan menunjukkan
                                bahwa kamu peduli dengan pekerjaanmu. Sudahkah kamu mempersiapkan presentasimu? Mungkin kita
                                bisa membahas beberapa teknik pernapasan atau visualisasi positif yang bisa membantumu
                                merasa lebih tenang.</p>
                        </div>
                    </div>
                    <div class="flex items-start justify-end">
                        <div class="chat-bubble-user bg-primary p-3 max-w-[80%] text-white text-sm">
                            <p>Iya, aku sudah menyiapkan materinya, tapi tetap saja merasa gugup. Biasanya aku jadi blank
                                saat banyak orang menatapku.</p>
                        </div>
                    </div>
                    <div class="flex items-start">
                        <div class="chat-bubble-ai bg-gray-100 p-3 max-w-[80%] text-gray-700 text-sm">
                            <p>Kamu sudah melangkah dengan baik dengan mempersiapkan materi! Untuk mengatasi kecemasan saat
                                presentasi, coba teknik 4-7-8: tarik napas selama 4 detik, tahan 7 detik, dan keluarkan
                                selama 8 detik. Lakukan beberapa kali sebelum presentasi.</p>
                            <p class="mt-2">Juga, ingat bahwa audiens ingin kamu berhasil. Mereka hadir untuk mendapatkan
                                informasi, bukan untuk mengkritik. Bagaimana kalau kamu mencoba visualisasi positif malam
                                ini? Bayangkan presentasimu berjalan lancar dan mendapat respons positif.</p>
                        </div>
                    </div>
                </div>
                <div class="relative">
