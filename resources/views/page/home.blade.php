    ...
    <section id="home-section" class="px-4 py-6 pb-16 w-full">
            ...
            <div class="container mx-auto px-4 relative z-10">
                <div class="w-full flex flex-col md:flex-row items-center">
                    <div class="w-full md:w-1/2 hero-gradient p-8 rounded-lg" style="background: rgba(255,255,255,0.2);">
                        ...
                        <p class="text-lg text-gray-800 mb-8 ">Gunakan Ceritia untuk melacak, memahami, dan meningkatkan
                            kesehatan emosional Anda. Aplikasi kami yang didukung AI akan membantu Anda memahami perasaan
                            Anda dan memantau perkembangan kesehatan Anda dari hari ke hari.</p>
        ...
        <section id="features" class="py-16 bg-white">
            <div class="container mx-auto px-4">
                <div class="text-center mb-12">
                    ...
                    <p class="text-gray-600 max-w-2xl mx-auto">Aplikasi kami menggabungkan teknologi modern dengan
                        kecerdasan emosional untuk memberi Anda dukungan yang dipersonalisasi.</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                        ...
                        <p class="text-gray-600">Lacak emosi Anda dengan antarmuka intuitif Ceritia dan dapatkan wawasan
                            serta rekomendasi aktivitas yang sesuai dengan pola emosi Anda.</p>
                    </div>
                    <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                        <div class="w-14 h-14 bg-primary bg-opacity-10 rounded-full flex items-center justify-center mb-4">
                            <div class="w-6 h-6 flex items-center justify-center text-primary">
                        ...
                        <p class="text-gray-600">Chatbot AI kami yang berempati memberikan dukungan, dorongan refleksi, dan
                            rekomendasi yang dipersonalisasi serta layanan bantuan darurat di kondisi yang emergency.</p>
                    </div>
                    <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                        <div class="w-14 h-14 bg-primary bg-opacity-10 rounded-full flex items-center justify-center mb-4">
                            <div class="w-6 h-6 flex items-center justify-center text-primary">
                        ...
                        <p class="text-gray-600">Visualisasi perjalanan emosional Anda dengan analisis komprehensif dan
                            wawasan yang dapat menyelesaikan masalah Anda, serta hewan peliharaan virtual pilihan Anda.</p>
                    </div>
                    <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                        <div class="w-14 h-14 bg-primary bg-opacity-10 rounded-full flex items-center justify-center mb-4">
                            <div class="w-6 h-6 flex items-center justify-center text-primary">
                        ...
                        <p class="text-gray-600">Terhubung dengan orang lain dalam perjalanan yang sama dan membangun
                            komunitas yang mendukung untuk pertumbuhan emosional.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="app-interface" class="py-16 bg-primary bg-opacity-10">
            <div class="container mx-auto px-4">
                <div class="text-center mb-12">
                    ...
                    <p class="text-gray-700 max-w-2xl mx-auto">Dirancang dengan cermat untuk memberikan pengalaman pengguna
                        yang menenangkan dan intuitif.</p>
                </div>
                <div class="flex-1 flex-2 md:flex 1-2 gap-7 justify-center items-stretch">
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 w-full md:w-1/3 flex flex-col">
                        ...
                        <div class="flex flex-col gap-2 mb-2">
                            ...
                            <div class="self-end bg-primary text-white px-4 py-2 rounded-2xl max-w-[80%]">Aku merasa agak
                                cemas tentang presentasiku besok.</div>
                            <div
                                class="self-start bg-primary bg-opacity-10 text-gray-800 px-4 py-2 rounded-2xl max-w-[80%]">
                                Saya mengerti. Apakah Anda ingin mencoba latihan pernapasan cepat untuk membantu menenangkan
                                saraf Anda?</div>
                        </div>
                        <input type="text"
                ...
                <div class="flex flex-col md:flex-row items-center gap-12">
                    <div class="w-full md:w-1/2">
                        <img src="https://readdy.ai/api/search-image?query=A%20calming%20and%20serene%20image%20showing%20a%20person%20meditating%20or%20practicing%20mindfulness%20in%20a%20peaceful%20natural%20setting.%20The%20image%20has%20soft%20blue%20and%20green%20tones%2C%20with%20gentle%20lighting%20that%20creates%20a%20tranquil%20atmosphere.%20The%20background%20shows%20elements%20of%20nature%20like%20water%2C%20trees%2C%20or%20mountains%20that%20convey%20peace%20and%20emotional%20wellbeing.%20The%20composition%20is%20balanced%20with%20the%20person%20as%20the%20main%20focus%2C%20showing%20a%20state%20of%20calm%20and%20emotional%20balance.&width=600&height=400&seq=feature1&orientation=landscape"
                            alt="Mindfulness features" class="w-full h-auto rounded-lg shadow-lg object-cover object-top">
                    </div>
                    <div class="w-full md:w-1/2">
                        ...
                        <div class="space-y-6">
                            <div class="flex">
                                ...
                                <div>
                                    <h3 class="text-xl font-semibold text-gray-800 mb-2">Deteksi Suasana Hati yang Didukung
                                        AI</h3>
                                    <p class="text-gray-600">Algoritme canggih kami menganalisis input Anda untuk
                                        mengidentifikasi kondisi emosi Anda secara akurat dan memberikan dukungan yang
                                        relevan.</p>
                                </div>
                            </div>
                            <div class="flex">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">Dapatkan bantuan segera kapan pun Anda membutuhkannya, dengan
                                        pendamping AI kami yang tersedia sepanjang waktu untuk membantu Anda memproses emosi
                                        Anda.</p>
                                </div>
                            </div>
                            <div class="flex">
                                ...
                                <div>
                                    <h3 class="text-xl font-semibold text-gray-800 mb-2">Integrasi yang dapat Digunakan
                                    </h3>
                                    <p class="text-gray-600">Hubungkan dengan pelacak kebugaran dan jam tangan pintar Anda
                                        untuk mendapatkan wawasan yang lebih dalam tentang bagaimana kesehatan fisik Anda
                                        memengaruhi kesejahteraan emosional Anda.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section id="testimonials" class="py-16 bg-gray-50">
            <div class="container mx-auto px-4">
                <div class="text-center mb-12">
                    ...
                    <p class="text-gray-600 max-w-2xl mx-auto">Kata mereka yang telah mengubah kesejahteraan emosional
                        mereka dengan Ceritia.</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="bg-white rounded-lg shadow p-6 flex flex-col items-center">
                        <img src="https://randomuser.me/api/portraits/women/10.jpg" class="w-16 h-16 rounded-full mb-2"
                            alt="User 1">
                        <p class="text-gray-700 text-center mb-2">"Ceritia membantu saya memahami emosi saya dan selalu ada
                            ketika saya membutuhkan dukungan setiap hari."</p>
                        <span class="text-sm text-primary font-semibold">Mira, 19</span>
                    </div>
                    <div class="bg-white rounded-lg shadow p-6 flex flex-col items-center">
                        <img src="https://randomuser.me/api/portraits/men/60.jpg" class="w-16 h-16 rounded-full mb-2"
                            alt="User 2">
                        <p class="text-gray-700 text-center mb-2">"Pelacakan suasana hati dan fitur komunitas sangat
                            membantu ketika saya sedang bingung dengan kondisi emosional saya dan membutuhkan seseorang
                            untuk berbagi cerita."</p>
                        <span class="text-sm text-primary font-semibold">Aris, 24</span>
                    </div>
                    <div class="bg-white rounded-lg shadow p-6 flex flex-col items-center">
                        <img src="https://randomuser.me/api/portraits/women/40.jpg" class="w-16 h-16 rounded-full mb-2"
                            alt="User 3">
                        <p class="text-gray-700 text-center mb-2">"Saya suka dashboard analisis. Itu membantu saya dalam
                            melihat kemajuan diri saya dan tetap termotivasi."</p>
                        ...
                        <div class="space-y-6">
                            <div class="flex">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">Dapatkan poin dan hadiah saat Anda menyelesaikan aktivitas
                                        yang meningkatkan kesejahteraan emosional Anda.</p>
                                </div>
                            </div>
                            <div class="flex">
                                <div
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">Bangun kebiasaan sehat melalui pemeriksaan harian dan
                                        aktivitas yang memperkuat praktik emosional yang positif.</p>
                                </div>
                            </div>
                            <div class="flex">
                                <div
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">Bergabunglah dengan kegiatan dan tantangan komunitas untuk
                                        terhubung dengan orang lain dan saling memotivasi dalam perjalanan kesejahteraan
                                        emosional Anda.</p>
                                </div>
                            </div>
                        </div>
        ...
        <section class="py-16 bg-gray-50">
            <div class="container mx-auto px-4">
                <div class="text-center mb-12">
                    ...
                    <p class="text-gray-600 max-w-2xl mx-auto mb-8">Profil yang beradaptasi dengan perjalanan emosional
                        Anda yang unik, memberikan dukungan yang disesuaikan di setiap langkah.</p>
                </div>
                <div class="flex flex-col md:flex-row gap-8 items-center justify-center">
                    <div class="bg-white rounded-lg shadow p-6 flex flex-col items-center w-full md:w-1/3">
                        ...
                        <p class="text-gray-600 text-center mb-2">Lacak riwayat suasana hati Anda, tetapkan tujuan, dan
                            sesuaikan pengalaman Anda.</p>
                    </div>
                    <div class="bg-white rounded-lg shadow p-6 flex flex-col items-center w-full md:w-1/3">
                        <i class="ri-flag-2-line text-primary text-4xl mb-2"></i>
                        <h3 class="text-xl font-semibold text-gray-800 mb-1">Tujuan</h3>
                        <p class="text-gray-600 text-center mb-2">Tetapkan sasaran kesejahteraan emosional dan pantau
                            perkembangan hidup Anda dari waktu ke waktu.</p>
                    </div>
                    <div class="bg-white rounded-lg shadow p-6 flex flex-col items-center w-full md:w-1/3">
                        ...
                        <p class="text-gray-600 text-center mb-2">Tinjau kembali aktivitas Anda di masa lalu dan lihat
                            bagaimana kebiasaan Anda memengaruhi suasana hati Anda.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-16 bg-white">
            <div class="container mx-auto px-4">
                <div class="text-center mb-12">
                    ...
                    <p class="text-gray-600 max-w-2xl mx-auto">Pilih paket yang paling sesuai dengan kebutuhan kesehatan
                        emosional Anda</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    ...
                    <div
                        ...
                        <p class="text-gray-600 mb-4">Analisis tingkat lanjut, obrolan AI tanpa batas, dan lebih banyak
                            fitur.</p>
        ...
        <section class="py-16 bg-primary bg-opacity-5">
            <div class="container mx-auto px-4 text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-4">Mulailah Perjalanan Kesejahteraan Emosional Anda Hari Ini
                </h2>
                <p class="text-gray-600 max-w-2xl mx-auto mb-8">Bergabunglah dengan ribuan pengguna yang mengubah hubungan
                    mereka dengan emosi mereka dan membangun ketahanan dari hari ke hari.</p>
