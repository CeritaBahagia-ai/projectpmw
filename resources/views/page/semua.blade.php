            ...
            <section id="calm-zone-section" class="px-4 py-6 hidden">
                <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
                    ...
                    <div class="flex space-x-2 mb-4">
                        <button id="tab-calm-breath"
                            class="px-4 py-2 rounded-full text-sm font-medium bg-primary text-white focus:outline-none">Napas</button>
                        <button id="tab-calm-journal"
                            class="px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-800 focus:outline-none">Jurnal</button>
                        <button id="tab-calm-affirm"
                            class="px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-800 focus:outline-none">Afirmasi</button>
                        <button id="tab-mood-diary"
                            class="px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-800 focus:outline-none">Mood
                            Diary</button>
                    </div>
                    <!-- Napas -->
                    <div id="tab-content-calm-breath">
                        <div class="flex flex-col items-center">
                            <div id="breath-circle"
                                class="w-28 h-28 mb-4 rounded-full bg-primary opacity-80 transition-all duration-400 ease-in-out">
                            </div>
                            <div id="breath-text" class="mb-4 text-sm text-gray-700">Klik mulai untuk relaksasi</div>
                            <button id="start-breathing"
                                class="bg-secondary text-white px-6 py-2 rounded-full font-medium text-sm">Mulai Latihan
                                Pernapasan</button>
                        </div>
                    </div>
                    <!-- Jurnal -->
                    <div id="tab-content-calm-journal" class="hidden">
                        <form id="journal-form" class="flex flex-col items-center">
                            <textarea id="journal-text" rows="3"
                                class="w-full border border-gray-200 rounded p-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent mb-3"
                                placeholder="Tulis perasaanmu hari ini..."></textarea>
                            <button type="submit"
                                class="bg-primary text-white px-6 py-2 rounded-full font-medium text-sm">Catat
                                Jurnal</button>
                            <div id="journal-success" class="mt-3 text-green-600 text-sm hidden">Jurnal tersimpan! 🎉
                            </div>
                        </form>
                    </div>
                    <!-- Afirmasi -->
                    <div id="tab-content-calm-affirm" class="hidden">
                        ...
                        <button id="next-affirmation"
                            class="bg-primary text-white px-6 py-2 rounded-full font-medium text-sm">Afirmasi
                            Lainnya</button>
                    </div>
                </div>
                <!-- Mood Diary Visual -->
                <div id="tab-content-mood-diary" class="hidden">
                    <div id="affirmation-text" class="text-lg text-primary font-semibold mb-4">"Kamu berharga dan
                        mclass="grid grid-cols-2 md:grid-cols-4 gap-4" id="mood-diary-gallery"></div>
                </div>
    </div>
